library dropdown_button_vconnex;
...
class _DropdownMenuRouteLayout<T> extends SingleChildLayoutDelegate {
  ...
  Offset getPositionForChild(Size size, Size childSize) {
    ...
    final double dropdownHeight = childSize.height;

    // Check if dropdown menu will go off the bottom of the screen
    bool isDropdownBelowScreen = buttonBottom + dropdownHeight > screenHeight;

    if (isDropdownBelowScreen) {
      // Show dropdown above the button
      return Offset(buttonRect.left + offset.dx, buttonTop - dropdownHeight + offset.dy);
    } else {
      // Show dropdown below the button
      return Offset(buttonRect.left + offset.dx, buttonBottom + offset.dy);
    }
  }
